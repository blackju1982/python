...
def inputGraph(lines):
    ...
    for i in lines:
        if i == "#end":
            ...
            b = searchForVertex(graph, edge[1])
...
if selection == "input":
    ...
    if (start != False and end != False):
        ...
        path = construct_path(start, end, discovered)

    # adjacencyMatrix(graph)

    transitiveGraph = floyd_warshall(graph)
    adjacencyMatrix(transitiveGraph)
